    ...
    Partial Public Class OrderRow
        ...
        Public Property 日期() As Date
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("資料表 'Order' 中資料行 '日期' 的值是 DBNull。", e)
                End Try
            End Get
            Set
        ...
        Public Property 電影名稱() As String
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("資料表 'Order' 中資料行 '電影名稱' 的值是 DBNull。", e)
                End Try
            End Get
            Set
        ...
        Public Property 票數() As Integer
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("資料表 'Order' 中資料行 '票數' 的值是 DBNull。", e)
                End Try
            End Get
            Set
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Function Is日期Null() As Boolean
            Return Me.IsNull(Me.tableOrder.日期Column)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Sub Set日期Null()
            Me(Me.tableOrder.日期Column) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Function Is電影名稱Null() As Boolean
            Return Me.IsNull(Me.tableOrder.電影名稱Column)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Sub Set電影名稱Null()
            Me(Me.tableOrder.電影名稱Column) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Function Is票數Null() As Boolean
            Return Me.IsNull(Me.tableOrder.票數Column)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Sub Set票數Null()
            Me(Me.tableOrder.票數Column) = Global.System.Convert.DBNull
        End Sub
...
Namespace BookingAndEventsDataSetTableAdapters
    ...
    Partial Public Class OrderTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Order] WHERE (([訂單編號] = @Original_訂單編號) AND ((@IsNull_日期 = 1 A"& _ 
                "ND [日期] IS NULL) OR ([日期] = @Original_日期)) AND ((@IsNull_電影名稱 = 1 AND [電影名稱] IS "& _ 
                "NULL) OR ([電影名稱] = @Original_電影名稱)) AND ((@IsNull_票數 = 1 AND [票數] IS NULL) OR (["& _ 
                "票數] = @Original_票數)) AND ((@IsNull_影廳 = 1 AND [影廳] IS NULL) OR ([影廳] = @Original"& _ 
                "_影廳)) AND ((@IsNull_場次 = 1 AND [場次] IS NULL) OR ([場次] = @Original_場次)) AND ((@Is"& _ 
                "Null_距離觀影日還有幾天 = 1 AND [距離觀影日還有幾天] IS NULL) OR ([距離觀影日還有幾天] = @Original_距離觀影日還有幾"& _ 
                "天)) AND ((@IsNull_電話 = 1 AND [電話] IS NULL) OR ([電話] = @Original_電話)))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_訂單編號", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "訂單編號", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@IsNull_日期", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "日期", Global.System.Data.DataRowVersion.Original, true, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_日期", Global.System.Data.SqlDbType.[Date], 0, Global.System.Data.ParameterDirection.Input, 0, 0, "日期", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Order] SET [訂單編號] = @訂單編號, [日期] = @日期, [電影名稱] = @電影名稱, [票數] = @票數, "& _ 
                "[影廳] = @影廳, [場次] = @場次, [電話] = @電話 WHERE (([訂單編號] = @Original_訂單編號) AND ((@IsNul"& _ 
                "l_日期 = 1 AND [日期] IS NULL) OR ([日期] = @Original_日期)) AND ((@IsNull_電影名稱 = 1 AND "& _ 
                "[電影名稱] IS NULL) OR ([電影名稱] = @Original_電影名稱)) AND ((@IsNull_票數 = 1 AND [票數] IS N"& _ 
                "ULL) OR ([票數] = @Original_票數)) AND ((@IsNull_影廳 = 1 AND [影廳] IS NULL) OR ([影廳] ="& _ 
                " @Original_影廳)) AND ((@IsNull_場次 = 1 AND [場次] IS NULL) OR ([場次] = @Original_場次))"& _ 
                " AND ((@IsNull_距離觀影日還有幾天 = 1 AND [距離觀影日還有幾天] IS NULL) OR ([距離觀影日還有幾天] = @Origina"& _ 
                "l_距離觀影日還有幾天)) AND ((@IsNull_電話 = 1 AND [電話] IS NULL) OR ([電話] = @Original_電話)));"& _ 
                ""&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT 訂單編號, 日期, 電影名稱, 票數, 影廳, 場次, 距離觀影日還有幾天, 電話 FROM [Order] WHERE (訂單編號 = @訂"& _ 
                "單編號)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@訂單編號", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "訂單編號", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@日期", Global.System.Data.SqlDbType.[Date], 0, Global.System.Data.ParameterDirection.Input, 0, 0, "日期", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
